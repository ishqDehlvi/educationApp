...
public class MockTestListAdapter extends RecyclerView.Adapter<MockTestListAdapter.MyViewHolder> {
    ...
    public MockTestListAdapter(Context context, ArrayList<SubTypeDataModel.List> arrayList, int iconId,Bundle navigationData) {
        ...
        holder.clChapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pref.getString(Constant.LOGIN_USING).contentEquals(Constant.LOGIN_TYPE_GUEST) &&
                    ...
                    Navigation.findNavController(v).navigate(R.id.action_mockTestListFragment_to_mcqTestFragment, navigationData);
                }
            }
        });
    }
