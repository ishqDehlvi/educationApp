...
public class PreviousYearsAdapter extends RecyclerView.Adapter<PreviousYearsAdapter.MyViewHolder> {
    ...
    public PreviousYearsAdapter(Context context, ArrayList<SubTypeDataModel.List> arrayList, int iconId, Bundle navigationData) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.clChapter.setOnClickListener(new View.OnClickListener() {
            ...
            /*holder.clChapter.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {*/
                    openChoiceDialog(v, arrayList.get(holder.getAdapterPosition()).getPreYrFile(), holder.getAdapterPosition());
              /*  }
            });*/
                }
            }
    ...
    private void openChoiceDialog(final View view, final String prevYearUrl, final int pos) {
        ...
        btnChooseNcrt.setVisibility(View.GONE);
       /* btnChooseNcrt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.dismiss();
                Navigation.findNavController(view).navigate(R.id.action_previousYearsListFragment_to_solvedPapersFragment);
        ...
        btnChooseSolvedPapers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(view).navigate(R.id.action_previousYearsListFragment_to_pdfListingFragment, navigationData);
                /*if (!prevYearUrl.isEmpty()) {
                    dialog.dismiss();
                    navigationData.putString(Constant.PDF_URL, pdfUrl + prevYearUrl);
                    Navigation.findNavController(view).navigate(R.id.action_chapterListFragment_to_pdfListingFragment);
                } else {
        ...
        btnChoosePractice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*dialog.dismiss();
                Navigation.findNavController(view).navigate(R.id.action_previousYearsListFragment_to_mcqTestFragment);*/

                dialog.dismiss();
                navigationData.putString(Constant.SELECTED_TYPE_ID, arrayList.get(pos).getTypeId());
                navigationData.putString(Constant.SELECTED_TYPE_NAME, arrayList.get(pos).getTypeTitle());
                Navigation.findNavController(view).navigate(R.id.action_previousYearsListFragment_to_mcqTestFragment, navigationData);
